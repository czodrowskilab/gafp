...
def parse_options():
    ...
    parser.add_argument('--sdf',metavar='SDF',type=str,default=default_sdf,help="sdf to use")
    ...
    parser.add_argument('--folder',default=None,type=str,help='Folder to load/save new sdf-files and pickle-files.')
    ...
    parser.add_argument('--log', type=str, default=None, help='file to write csv-log into.')
    ...
    parser.add_argument("--external_test", type=str, default="None", help="asd")
    parser.add_argument('--local', default=False, action='store_true', help="Try to run locally (on something with a gpu). Doesn't work yet.")
